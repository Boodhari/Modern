...
// Fetch patient names from visitors table
$visitors_result = $conn->query("SELECT id, full_name FROM visitors ORDER BY visit_date DESC");
...
<body class="container py-4">
  ...
  <form method="POST" class="row g-3">
    ...
    <div class="col-md-4">
      <label class="form-label">Total Price (SLSH)</label>
